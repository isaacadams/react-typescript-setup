...
var MyReactApp = /** @class */ (function (_super) {
    __extends(MyReactApp, _super);
    ...
    MyReactApp.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("button", { onClick: this.handleClick }, "Click Me"),
            React.createElement("br", null),
            React.createElement(dropdown_jsx_1.Dropdown, { items: ['choice1', 'choice2', 'choice3'] })));
    };
    return MyReactApp;
}(React.Component));
ReactDOM.render(React.createElement(MyReactApp, { alertMessage: 'Hello World' }), document.getElementById('app'));

},{"./components/dropdown.jsx":17,"react":10,"react-dom":7}]},{},[18]);
